            ...
            <SwiperSlide className="swiper-slide">
              ...
              >
                ...
                <div className="catagory-product-content text-center">
                  ...
                  <h3>
                    <Link href="/shop-single">BBQ Roll</Link>
                  </h3>
                  <p>8 products</p>
                </div>
              </div>
            ...
            <SwiperSlide className="swiper-slide">
              ...
              >
                ...
                <div className="catagory-product-content text-center">
                  ...
                  <h3>
                    <Link href="/shop-single">Special Platter</Link>
                  </h3>
                  <p>2 products</p>
                </div>
              </div>
            ...
            <SwiperSlide className="swiper-slide">
              ...
              >
                ...
                <div className="catagory-product-content text-center">
                  ...
                  <h3>
                    <Link href="/shop-single">Starter</Link>
                  </h3>
                  <p>7 products</p>
                </div>
              </div>
            ...
            <SwiperSlide className="swiper-slide">
              ...
              >
                ...
                <div className="catagory-product-content text-center">
                  ...
                  <h3>
                    <Link href="/shop-single">Traditional</Link>
                  </h3>
                  <p>4 products</p>
                </div>
              </div>
            ...
            <SwiperSlide className="swiper-slide">
              ...
              >
                ...
                <div className="catagory-product-content text-center">
                  ...
                  <h3>
                    <Link href="/shop-single">BBQ</Link>
                  </h3>
                  <p>9 products</p>
                </div>
              </div>
            ...
            <SwiperSlide className="swiper-slide">
              ...
              >
                ...
                <div className="catagory-product-content text-center">
                  ...
                  <h3>
                    <Link href="/shop-single">Gyro Combos</Link>
                  </h3>
                  <p>5 products</p>
                </div>
              </div>
